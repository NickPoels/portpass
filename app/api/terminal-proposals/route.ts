...
export async function POST(request: NextRequest) {
    try {
        ...
        const { portId, name, latitude, longitude } = body;
        ...
        const proposal = await prisma.terminalProposal.create({
            data: {
                portId,
                name,
...
export async function PATCH(request: NextRequest) {
    try {
        ...
        const proposal = await prisma.terminalProposal.update({
            where: { id },
            data: updateData,
            include: {
                port: true
...
export async function DELETE(request: NextRequest) {
    try {
        ...
        await prisma.terminalProposal.delete({
            where: { id }
        });
